							...
							<div class="d-none ${this._data.user ? "" : "d-lg-flex"} justify-content-center align-items-center">
								<form class="d-flex align-items-center auth-form">
									...
									<div class="input-group input-group-sm pe-2">
										...
										<input type="password" name="password" placeholder="Password" tabindex="3" title="Insert your password" class="form-control" autocomplete="off" required>
									</div>
									<div class="pe-2">
							...
							<div class="${this._data.user ? "d-none" : "d-lg-none"}">
								<form class="auth-form mt-3">
									...
									<div class="input-group mb-3">
										...
										<input type="password" name="password" placeholder="Password" tabindex="2" title="Insert your Password" class="form-control" autocomplete="off" required>
									</div>
									<div class="row mb-2">
										<div class="col-6 pe-1">
											<input type="submit" value="login" title="Click to log in" tabindex="3" class="btn btn-outline-primary w-100 text-uppercase" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar">
										</div>
										<div class="col-6 ps-1">
											<input type="submit" value="signup" title="Click to sign up" tabindex="4" class="btn btn-primary w-100 text-uppercase" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar">
										</div>
									</div>
								</form>
							...
							<div class="list-group list-group-flush fw-medium text-uppercase w-100">
								...
								<div class="dropdown list-group-item list-group-item-action">
									...
									<ul class="dropdown-menu fw-medium text-uppercase w-100">
										<li title="Italiano" rel="nofollow" class="dropdown-item">
											<span>
												<img src="/static/images/italy.svg" alt="mdo" width="16" height="16" class="me-2">
											</span>
											Italiano
										</li>
										<li title="Français" rel="nofollow" class="dropdown-item">
											<span>
